...
func (l SecondaryLayer) Seek(k ServiceInfo) (e *SecondaryEnumerator, ok bool) {
	l.lock.Lock()
	e, ok = l.store.Seek(k)
	l.lock.Unlock()
	return
...
func (prev SecondaryLayer) addAll(nextLock lockie.Lockie, nextIter *SecondaryEnumerator, onAdd func(k ServiceInfo)) {
	nextLock.Lock()
...
func (prev SecondaryLayer) deleteAll(prevIter *SecondaryEnumerator, onDel func(k ServiceInfo)) {
	prev.lock.Lock()
...
func (prev SecondaryLayer) syncAll(next SecondaryLayer, prevIter, nextIter *SecondaryEnumerator, onAdd, onDel func(k ServiceInfo)) {
	prev.lock.Lock()
