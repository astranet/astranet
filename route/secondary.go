...
func (prev SecondaryLayer) addAll(nextLock lockie.Lockie, nextIter *SecondaryEnumerator, onAdd func(k RouteInfo)) {
	nextLock.Lock()
...
func (prev SecondaryLayer) deleteAll(prevIter *SecondaryEnumerator, onDel func(k RouteInfo)) {
	prev.lock.Lock()
...
func (prev SecondaryLayer) syncAll(next SecondaryLayer, prevIter, nextIter *SecondaryEnumerator, onAdd, onDel func(k RouteInfo)) {
	prev.lock.Lock()
